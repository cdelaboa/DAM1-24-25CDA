...
public class CalculadoraHumana {
    public static void main(String[] args) {
        ...
        final int numMax = 200;
        int numeroAleatorio1 = random.nextInt(100);
        int numeroAleatorio2 = random.nextInt(numMax);
        ...
        if (respuesta == resultado) {
            System.out.println(
                    "Es correcto, el resultado de la operación " + numeroAleatorio1 + operador + numeroAleatorio2);
                    System.out.println("Vamos a seguir operando ");

        } else {
            System.out.println(
                    "Es incorrecto, el resultado de la operación " + numeroAleatorio1 + operador + numeroAleatorio2);
        }
    }
